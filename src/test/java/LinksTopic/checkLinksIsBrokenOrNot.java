...
public class checkLinksIsBrokenOrNot {

	@Test
	public void numberOfLinksInFirstColoum() throws Throwable, Throwable {
	...
	public void verifyLink(String li) throws Throwable {
		// creating the object of urlconnection class and calling open connection method
		// and casting to Http
		HttpURLConnection conn = (HttpURLConnection) new URL(li).openConnection();
...
//		a.assertTrue(conn.getResponseCode() >= 400, li + "=" + conn.getResponseCode() + " is a broken link");
//		a.assertTrue(conn.getResponseCode() <= 200, li + conn.getResponseCode());
